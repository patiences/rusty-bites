...
fn main() -> () {
    ...
    bb3: {
        ...
        _1 = std::slice::<impl [T]><i32>::into_vec(_2) -> [return: bb4, unwind:
bb2]; // scope 0 at <vec macros>:3:1: 3:48
    }
    ...
    bb5: {
        ...
        _8 = <std::vec::Vec<i32> as std::ops::Index<usize>>::index(_9, const 6usize) -> [return: bb7, unwind: bb6]; // scope 1 at <anon>:3:13: 3:19
    }
